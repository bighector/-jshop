...
public class IntrospectedColumn {
    ...
    protected boolean isInsertIgnore;
    protected boolean isUpdateIgnore;
    protected String insertReplaceStr;
    protected String updateReplaceStr;
    ...
    public void setIsInsertIgnore(boolean isInsertIgnore) {
    ...
    public void setIsUpdateIgnore(boolean isUpdateIgnore) {
        this.isUpdateIgnore = isUpdateIgnore;
    }

    public String getInsertReplaceStr() {
        return insertReplaceStr;
    }

    public void setInsertReplaceStr(String insertReplaceStr) {
        this.insertReplaceStr = insertReplaceStr;
    }

    public String getUpdateReplaceStr() {
        return updateReplaceStr;
    }

    public void setUpdateReplaceStr(String updateReplaceStr) {
        this.updateReplaceStr = updateReplaceStr;
    }
}
