...
public class TableConfiguration extends PropertyHolder {
    ...
    /** sqlmap generate:新增时忽略. */
    private List<String> columnInsertIgnores;

    /** sqlmap generate:更新时忽略. */
    private List<String> columnUpdateIgnores;

    /** sqlmap generate:更新时使用对应的值替换 */
    private Map<String, String> columnInsertReplaces;

    /** sqlmap generate:更新时使用对应的值替换 */
    private Map<String, String> columnUpdateReplaces;
    /**
    ...
    public TableConfiguration(Context context) {
        ...
        columnInsertIgnores = new ArrayList<String>();
        columnUpdateIgnores = new ArrayList<String>();
        columnInsertReplaces = new HashMap<String, String>();
        columnUpdateReplaces = new HashMap<String, String>();
    ...
    public List<String> getColumnInsertIgnores() {
        return columnInsertIgnores;
    }

    public List<String> getColumnUpdateIgnores() {
        return columnUpdateIgnores;
    }

    public Map<String, String> getColumnInsertReplaces() {
        return columnInsertReplaces;
    }

    public Map<String, String> getColumnUpdateReplaces() {
        return columnUpdateReplaces;
    }

    public void addColumnInsertIgnore(String column) {
        columnInsertIgnores.add(column.toLowerCase());
    }
    public void addColumnUpdateIgnore(String column) {
        columnUpdateIgnores.add(column.toLowerCase());
    }
    public void addColumnInsertReplace(String column, String replaceBy) {
        columnInsertReplaces.put(column.toLowerCase(), replaceBy);
    }
    public void addColumnUpdateReplace(String column, String replaceBy) {
        columnUpdateReplaces.put(column.toLowerCase(), replaceBy);
    }

    public boolean isColumnInsertIgnored(String column) {
        return columnInsertIgnores.contains(column.toLowerCase());
    }

    public boolean isColumnUpdateIgnored(String column) {
        return columnUpdateIgnores.contains(column.toLowerCase());
    }
}
