...
<@page.pageBase currentMenu="友情链接">
    <form action="${basepath}/manage/navigation" name="form" id="form">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td style="text-align: left;">
					<input type="text"  value="${e.linkLogo!""}" name="linkLogo" size="50"  data-rule="required;name;length[1~100];" id="linkLogo" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right;">顺序</td>
				<td style="text-align: left;"><input type="text"  value="${e.ordinal!""}" size="5" name="ordinal"  data-rule="顺序:integer;order1;length[1~5];"
						id="order1" /></td>
			</tr>
			<tr>
