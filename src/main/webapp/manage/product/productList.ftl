...
<!-- 							<i class="icon-arrow-up icon-white"></i> 上架 -->
					...
					<a target="_blank" href="${systemSetting().website}/product/selectMemoryStock.html" class="btn btn-info">
...
<!-- 							<font color='blue'>特价</font> -->
					...
					<a target="_blank" href="${systemSetting().website}/product/${item.id!""}.html">查看</a>
					</td>
				</tr>
            </#list>
