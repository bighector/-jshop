					...
					<div class="panel-heading" style="text-align: left;">
		              ...
		              <div class="panel-body" style="font-size: 16px;font-weight: normal;text-align: center;">
						  <#if reset_password_email_timeout??>
                              ...
                              <a style="display: none;" class="btn btn-success btn-sm" href="${systemSetting().website}/accountdoForget.html?account=${e.account!""}"><span class="glyphicon glyphicon-send"></span>&nbsp;重新发送邮件</a>
