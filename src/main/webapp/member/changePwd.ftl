	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-9">
                ...
                <hr>
				<form role="form" id="form" method="post" class="form-horizontal jqtransform" action="${basepath}/member/doChangePwd" autocomplete="off" theme="simple" >
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-lg-6">
					    ...
					    data-rule="旧密码:required;password;remote[checkPassword]" placeholder="请输入原密码" />
				    </div>
				  </div>
