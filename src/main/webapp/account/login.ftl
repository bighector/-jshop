...
<#--&lt;#&ndash;<%-- 						<span id="wb_connect_btn" title="使用新浪微博号登陆"></span> --%>&ndash;&gt;-->
	...
	<#--&lt;#&ndash;<%-- 							<img src="${systemSetting().website}/resource/images/alipay.gif" alt="支付宝快捷登陆"> --%>&ndash;&gt;-->
...
<script type="text/javascript">
	...
	function notifySession(status,openId,accessToken,nickname){
		var _url = "${systemSetting().website}/account/qqCallbackNotifySession?status="+status+"&openId="+openId+"&accessToken="+accessToken+"&nickname="+nickname;
		...
		$.ajax({
		  ...
		  success: function(data){
			  ...
			  window.location.href = "${systemSetting().website}";
		  },
		  dataType: "text",
		  error:function(er){
